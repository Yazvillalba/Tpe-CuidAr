...
const EditUserModal: React.FC<EditUserModalProps> = ({ show, onHide, user, onSuccess }) => {
          ...
          <div className="modal-header border-bottom border-gray-200 bg-transparent px-4 py-3">
            <div className="d-flex align-items-center gap-3">
              <div className="corazon rounded-circle d-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
                <Edit className="text-white" style={{ width: '20px', height: '20px' }} />
              </div>
              <div>
                <h5 className="modal-title fw-semibold text-gray-900 mb-0">Editar Usuario</h5>
                <p className="small text-gray-500 mb-0">Modifique la información del usuario</p>
              </div>
            </div>
            <button 
              type="button" 
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body px-4 py-3" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
              ...
              <div className="row g-3">
                ...
                <div className="col-md-6">
                  <label className="form-label small fw-semibold text-gray-700 mb-2">Estado</label>
                  <select 
                    name="status"
                    className="form-select border border-gray-300 rounded-xl px-3 py-2" 
                    style={{ fontSize: '0.875rem' }}
